...
public class VisualizarCaixa extends javax.swing.JDialog {
    ...
    public VisualizarCaixa(java.awt.Frame parent, boolean modal, String data) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.jLabelDataAtual.setText(Util.dataAtualFormatada());
        preencherListaPedidos(data);
        informacoes();
        exibir();
    }
